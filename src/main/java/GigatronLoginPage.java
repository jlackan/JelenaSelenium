...
public class GigatronLoginPage {
    ...
    By userPageElem = By.xpath("//span[@class='user-identity-name']//b[text()='Jelena']");

    //Locator for checking User full name
    By userFullNameElem = By.xpath( "//ul//li[contains(.,'Jelena L')]");
    ...
    public boolean checkUserLoginSuccess() {
        ...
        if (driver.findElement(userFullNameElem).getText().contains("Jelena L")) {
            System.out.println(driver.findElement(userFullNameElem).getText().contains("Jelena L"));
